module.exports.run = async (pw, message, args) => {
    ...
    else if (roll == 78 || roll == 79 || roll == 80 || roll == 81 || roll == 82 || roll == 94)
    message.reply("bạn đã quay trúng Coconut Water, chúc mừng!");

    else if (roll == 83 || roll == 84 || roll == 99)
    message.reply("bạn đã quay trúng Cheesecake, chúc mừng!");

    else if (roll == 85 || roll == 86 || roll == 87 || roll == 88 || roll == 89)
    ...
    else if (roll == 95 || roll == 96 || roll == 92)
