module.exports.run = async (pw, message, args) => {
    ...
    if (roll == 3 || roll == 96 || roll == 5 || roll == 6 || roll == 92 || roll == 8 || roll == 9 || roll == 66 || roll == 69 || roll == 12 || roll == 13 || roll == 14 || roll == 15 || roll == 16 || roll == 17 || roll == 18 || roll == 19 || roll == 20 || roll == 21 || roll == 22)
    message.reply("bạn đã quay trúng 50 <:poke:379535433467428867>, chúc mừng!");

    else if (roll == 1 || roll == 99 || roll == 64 || roll == 24 || roll == 25 || roll == 26 || roll == 71 || roll == 65 || roll == 29 || roll == 30 || roll == 31 || roll == 32 || roll == 33 || roll == 34 || roll == 35)
    ...
    else if (roll == 84 || roll == 85 || roll == 86 || roll == 87 || roll == 88 || roll == 89)
    message.reply("bạn đã quay trúng Watermelon Juice, chúc mừng!");

    else if (roll == 90 || roll == 91 || roll == 7)
    message.reply("bạn đã quay trúng Tiramisu, chúc mừng!");
