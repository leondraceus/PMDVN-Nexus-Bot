module.exports.run = async (pw, message, args) => {
    ...
    message.reply("bạn đã quay trúng 15 <:poke:379535433467428867>, chúc mừng! <:laugh1:374121408759988224>");
    ...
    message.reply("bạn đã quay trúng 75 <:poke:379535433467428867>, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 36 || roll == 37 || roll == 38 || roll == 39 || roll == 40 || roll == 41 || roll == 42 || roll == 43 || roll == 44 || roll == 45)
    message.reply("bạn đã quay trúng 150 <:poke:379535433467428867>, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 46 || roll == 47 || roll == 48 || roll == 49 || roll == 50)
    message.reply("bạn đã quay trúng 300 <:poke:379535433467428867>, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 51 || roll == 52)
    message.reply("bạn đã quay trúng 750 <:poke:379535433467428867>, chúc mừng! <:laugh1:374121408759988224>");
...
//    message.reply("bạn đã quay trúng Salt/Corsola Twig (Tùy chọn), chúc mừng! <:laugh1:374121408759988224>");
    message.reply("bạn đã quay trúng 5 Choco Heart, chúc mừng! <:laugh1:374121408759988224>");
    ...
    message.reply("bạn đã quay trúng Energy Juice, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 83)
    message.reply("bạn đã quay trúng Sweet Donut, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 84 || roll == 85 || roll == 86 || roll == 87 || roll == 88)
    message.reply("bạn đã quay trúng Heart Scale, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 89 || roll == 90 || roll == 91)
    message.reply("bạn đã quay trúng Lucky Wheel Banner, chúc mừng! <:laugh1:374121408759988224>");

    else if (roll == 92 || roll == 93 || roll == 94)
    message.reply("bạn đã quay trúng Victory Bell, chúc mừng! <:laugh1:374121408759988224>");
