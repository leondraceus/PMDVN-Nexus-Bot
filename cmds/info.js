...
//   }
    ...
    if(args[0]==="AD009"| args[0]==="ad009" | args[0]==="Ad009" | args[0]==="Fennekin" | args[0]==="fennekin"){
        var AD009 = new Discord.RichEmbed().setColor(`#2CE0C0`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://media.giphy.com/media/26iM80ArO8rdEQFQL8/giphy.gif`)
    ...
    if(args[0]==="AD010"| args[0]==="ad010" | args[0]==="Ad010" | args[0]==="Glaceon" | args[0]==="glaceon"){
        var AD010 = new Discord.RichEmbed().setColor(`#7A4AE6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://media.giphy.com/media/8mqy2gHdhcDmObQm6j/giphy.gif`)
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME008** | **.info ME618**`)
    ...
    if(args[0]==="ME121"| args[0]==="me121" | args[0]==="Me121"| args[0]==="Rockruff"| args[0]==="rockruff"){
        var ME121 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .addField(`Tên Facebook:`,`Ngân Ngô`)
            .addField(`Giới tính:`,`Nữ`)
...
//    }
    ...
    if(args[0]==="ME725"| args[0]==="Me725" | args[0]==="me725"){
        var ME725 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/0/0d/052-alola.gif`)
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME219** | **.info ME684**`)
    }
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME011** | **.info ME884**`)
    ...
    if(args[0]==="ME099"| args[0]==="Me099" | args[0]==="me099"){
        var ME099 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/6/69/Spring_Banner.png/revision/latest?cb=20180212012553`)
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME099** | **.info ME381**`)
    ...
    if(args[0]==="ME716"| args[0]==="Me716" | args[0]==="me716"| args[0]==="Skitty" | args[0]==="skitty"){
        var ME716 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Chủng loài:`,`Skitty`)
            .addField(`Tên Facebook:`,`Đoàn Thị Thanh`)
            .addField(`Giới tính:`,`Nữ`)
            .addField(`Ngày sinh:`,`16/12`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME514** | **.info ME978**`)
    ...
    if(args[0]==="ME868"| args[0]==="me868" | args[0]==="Me868" | args[0]==="Serperior" | args[0]==="serperior"){
        var ME868 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/4/40/Blaze_Banner.png/revision/latest?cb=20180510151521`)
...
Amazing Words (25/7/2018)`);
    ...
    if(args[0]==="ME819"| args[0]==="me819" | args[0]==="Me819" | args[0]==="Chandelure" | args[0]==="chandelure"){
        var ME819 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/6/69/609.gif`)
...
Chiếc nón Delibird 2 (3/7/2018 -> 10/7/2018)`);
    ...
    if(args[0]==="ME199"| args[0]==="me199" | args[0]==="Me199" | args[0]==="Feraligatr" | args[0]==="feraligatr"){
        var ME199 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Chủng loài:`,`Feraligatr`)
            .addField(`Tên Facebook:`,`Thinh Tran`)
            .addField(`Giới tính:`,`Nam`)
            .addField(`Ngày sinh:`,`25/7`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`---`);
...
Chân ải chân ai (18/7/2018)`)
            ...
            message.channel.sendEmbed(ACME394);
     }
    ...
    if(args[0]==="ME637"| args[0]==="me637" | args[0]==="Me637" | args[0]==="Primalkyogre" | args[0]==="primalkyogre" | args[0]==="primalKyogre" | args[0]==="PrimalKyogre"){
        var ME637 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Chủng loài:`,`Kyogre (Primal)`)
            .addField(`Tên Facebook:`,`Phuoc Phan`)
            .addField(`Giới tính:`,`Nam`)
            .addField(`Ngày sinh:`,`10/10`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`---`);
    ...
    if(args[0]==="ME019"| args[0]==="me019" | args[0]==="Me019" | args[0]==="Wurmple" | args[0]==="wurmple"){
        var ME019 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .addField(`Tên Facebook:`,`Henry Tran`)
            .addField(`Giới tính:`,`Nam`)
            .addField(`Ngày sinh:`,`28/10`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`---`);
    ...
    if(args[0]==="ME529"| args[0]==="me529" | args[0]==="Me529" | args[0]==="Gliscor" | args[0]==="gliscor"){
        var ME529 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Chủng loài:`,`Gliscor`)
            .addField(`Tên Facebook:`,`Yen Tran`)
            .addField(`Giới tính:`,`Nữ`)
            .addField(`Ngày sinh:`,`1/1`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`---`);
    ...
    if(args[0]==="ME781"| args[0]==="me781" | args[0]==="Me781" | args[0]==="Poochyena" | args[0]==="poochyena"){
        var ME781 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Chủng loài:`,`Poochyena`)
            .addField(`Tên Facebook:`,`Zucakovs Tran`)
            .addField(`Giới tính:`,`Nữ`)
            .addField(`Ngày sinh:`,`28/12`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info AD003** | **.info ME644**`)
    ...
    if(args[0]==="ME889"| args[0]==="me889" | args[0]==="Me889"){
        var ME889 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .addField(`Tên Facebook:`,`Usagi Nymphia`)
            .addField(`Giới tính:`,`Nữ`)
            .addField(`Ngày sinh:`,`29/8`)
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME889** | **.info ME635**`)
    ...
    if(args[0]==="ME724"| args[0]==="me724" | args[0]==="Me724"| args[0]==="Muk"| args[0]==="muk"){
        var ME724 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/d/d8/089.gif/revision/latest?cb=20180725063831`)
