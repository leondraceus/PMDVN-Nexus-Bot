...
//   }
    ...
    if(args[0]==="AD010"| args[0]==="ad010" | args[0]==="Ad010" | args[0]==="Glaceon" | args[0]==="glaceon"){
        var AD010 = new Discord.RichEmbed().setColor(`#7A4AE6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://media.giphy.com/media/oynutRQhc70kOG0CYs/giphy.gif`)
...
//    }
    ...
    if(args[0]==="ME725"| args[0]==="Me725" | args[0]==="me725"){
        var ME725 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/0/0d/052-alola.gif/revision/latest?cb=20180605134719`)
