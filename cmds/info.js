...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info AD005** | **.info ME191**`)
    ...
    if(args[0]==="AD006"| args[0]==="ad006" | args[0]==="Ad006" | args[0]==="Yveltal" | args[0]==="yveltal"){
        var AD006 = new Discord.RichEmbed().setColor(`#E7462B`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://media.giphy.com/media/24pcHAa42nCglEA0Lw/giphy.gif`)
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME983** | **.info ME452**`)
    ...
    if(args[0]==="ME394"| args[0]==="me394" | args[0]==="Me394" | args[0]==="Pichu" | args[0]==="pichu"){
        var ME394 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://media.giphy.com/media/1kJyJu2Q0j6lvClwjD/giphy.gif`)
            ...
            .addField(`Cấp bậc:`,`Member`)
            .addField(`Guild:`,`---`)
            .addField(`Thành tích:`,`Tổ chức Member Event: Is it your final choice? (25/3/2018)`);
