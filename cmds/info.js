...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME459** | **.info ME684** | **.info ME725**`)
    ...
    if(args[0]==="ME072"| args[0]==="Me072" | args[0]==="me072" | args[0]==="Dedenne" | args[0]==="dedenne"){
        var ME072 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/8/8f/Lucky_Banner.png/revision/latest/scale-to-width-down/637?cb=20180212012544`)
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.info ME983** | **.info ME452**`)
    ...
    if(args[0]==="ME303"| args[0]==="me303" | args[0]==="Me303" | args[0]==="Bewear" | args[0]==="bewear"){
        var ME303 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- THÔNG TIN -`).setImage(`https://i.imgur.com/jZE0T8G.gif`)
