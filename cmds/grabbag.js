...
module.exports.run = async (pw, message, args) => {
    ...
    var roll = Math.floor(Math.random() * 211) +1;

    if (roll == 29 || roll == 11 || roll == 19 || roll == 90 || roll == 25 || roll == 6 || roll == 27 || roll == 60 || roll == 9 || roll == 98 || roll == 86 || roll == 4 || roll == 58 || roll == 72 || roll == 85 || roll == 23 || roll == 95 || roll == 96 || roll == 71 || roll == 111 || roll == 112 || roll == 113 || roll == 114 || roll == 115 || roll == 116 || roll == 117 || roll == 118 || roll == 119 || roll == 120 || roll == 121 || roll == 122 || roll == 123 || roll == 124)
    ...
    else if (roll == 101 || roll == 102 || roll == 103 || roll == 104 || roll == 105 || roll == 106 || roll == 107 || roll == 108 || roll == 109 || roll == 110 || roll == 131 || roll == 132 || roll == 133 || roll == 134 || roll == 135 || roll == 136 || roll == 137 || roll == 138 || roll == 139 || roll == 140 || roll == 141 || roll == 142 || roll == 143 || roll == 144 || roll == 145 || roll == 146 || roll == 147)
        message.reply("trong Grab Bag có 1 Wooden Stick, chúc mừng!");    
        
    else if (roll == 82 || roll == 31 || roll == 78 || roll == 33 || roll == 34 || roll == 94 || roll == 36 || roll == 76 || roll == 38 || roll == 39 || roll == 201 || roll == 202 || roll == 203 || roll == 204 || roll == 148 || roll == 149 || roll == 150 || roll == 179 || roll == 180)
        message.reply("trong Grab Bag có 3 Wooden Stick, chúc mừng!");

    else if (roll == 64 || roll == 41 || roll == 42|| roll == 43 || roll == 67 || roll == 1 || roll == 205 || roll == 206 || roll == 207 || roll == 208 || roll == 209)
        message.reply("trong Grab Bag có 5 Wooden Stick, chúc mừng!");
        
    else if (roll == 7 || roll == 46 || roll == 47 || roll == 77 || roll == 49 || roll == 50 || roll == 51 || roll == 52 || roll == 88 || roll == 84 || roll == 125 || roll == 126 || roll == 127 || roll == 128 || roll == 129 || roll == 130)
    ...
    else if (roll == 8 || roll == 56 || roll == 62 || roll == 168 || roll == 169 || roll == 170 || roll == 186 || roll == 187 || roll == 188)
        message.reply("trong Grab Bag có 3 Sturdy Vine, chúc mừng!");

    else if (roll == 63 || roll == 40|| roll == 65|| roll == 66|| roll == 44 || roll == 166 || roll == 167 || roll == 178 || roll == 189 || roll == 190 || roll == 193)
    ...
    else if (roll == 32 || roll == 79 || roll == 161 || roll == 162 || roll == 163 || roll == 164 || roll == 165 || roll == 191 || roll == 192 || roll == 194)
    ...
    else if (roll == 53 || roll == 89 || roll == 196 || roll == 198 || roll == 211)
