...
module.exports.run = async (pw, message, args) => {
    ...
    if (roll == 29 || roll == 11 || roll == 19 || roll == 90 || roll == 25 || roll == 6 || roll == 27 || roll == 60 || roll == 9 || roll == 98 || roll == 86 || roll == 4 || roll == 58 || roll == 72 || roll == 85 || roll == 23 || roll == 95 || roll == 96 || roll == 71 || roll == 111 || roll == 112 || roll == 113 || roll == 114 || roll == 115 || roll == 116 || roll == 117 || roll == 118 || roll == 119)
    ...
    else if (roll == 101 || roll == 102 || roll == 103 || roll == 104 || roll == 105 || roll == 106 || roll == 107 || roll == 108 || roll == 109 || roll == 110 || roll == 131 || roll == 132 || roll == 133 || roll == 134 || roll == 135 || roll == 136 || roll == 137 || roll == 138 || roll == 139 || roll == 140 || roll == 141 || roll == 142 || roll == 143 || roll == 144 || roll == 145 || roll == 146)
        message.reply("trong Grab Bag có 1 Wooden Stick, chúc mừng!");    
        
    else if (roll == 82 || roll == 31 || roll == 78 || roll == 33 || roll == 34 || roll == 94 || roll == 36 || roll == 76 || roll == 38 || roll == 39 || roll == 148 || roll == 149 || roll == 150 || roll == 179 || roll == 180)
    ...
    else if (roll == 80 || roll == 21 || roll == 181 || roll == 182 || roll == 122 || roll == 123 || roll == 124)
        message.reply("trong Grab Bag có 1 Clear Paper, chúc mừng!");

    else if (roll == 30 || roll == 183 || roll == 184 || roll == 10 || roll == 120 || roll == 121 || roll == 147)
        message.reply("trong Grab Bag có 1 Prism, chúc mừng!");

    else if (roll == 18 || roll == 54 || roll == 195 || roll == 197)
        message.reply("trong Grab Bag có 1 Sun Ribbon, chúc mừng!");

    else if (roll == 53 || roll == 89 || roll == 196 || roll == 198)
