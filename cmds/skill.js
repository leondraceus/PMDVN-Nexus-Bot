...
///////////////   CONTRIBUTOR   ///////////////
    ...
    if(args[0]==="ME061"| args[0]==="me061" | args[0]==="Me061" | args[0]==="Pikachu" | args[0]==="pikachu"){
        var ME061 = new Discord.RichEmbed().setColor(`#5CE05F`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/f/fe/Contributor_Logo.png/revision/latest?cb=20170613043958`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐`)
            .addField(`Số điểm (Points):`,`465/525`)
    ...
    if(args[0]==="ME642"| args[0]==="me642" | args[0]==="Me642"){
        var ME642 = new Discord.RichEmbed().setColor(`#5CE05F`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/f/fe/Contributor_Logo.png/revision/latest?cb=20170613043958`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐`)
            .addField(`Số điểm (Points):`,`392/525`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Kho đồ được mở rộng`);
    ...
    if(args[0]==="ME329"| args[0]==="me329" | args[0]==="Me329" | args[0]==="Spinda" | args[0]==="spinda"){
        var ME329 = new Discord.RichEmbed().setColor(`#5CE05F`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/f/fe/Contributor_Logo.png/revision/latest?cb=20170613043958`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐`)
            .addField(`Số điểm (Points):`,`486/525`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME509** | **.skill ME264**`)
    ...
    if(args[0]==="ME392"| args[0]==="me392" | args[0]==="Me392" | args[0]==="Bisharp" | args[0]==="bisharp"){
        var ME392 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐`)
            .addField(`Số điểm (Points):`,`322/525`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME304** | **.skill ME319** | **.skill ME338** | **.skill ME982**`)
    ...
    if(args[0]==="ME008"| args[0]==="me008" | args[0]==="Me008"){
        var ME008 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐`)
            .addField(`Số điểm (Points):`,`330/450`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME008** | **.skill ME121**`)
    ...
    if(args[0]==="ME684"| args[0]==="me684" | args[0]==="Me684"){
        var ME684 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`---`)
            .addField(`Số điểm (Points):`,`24/150`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME459** | **.skill ME684** | **.skill ME725**`)
    ...
    if(args[0]==="ME072"| args[0]==="Me072" | args[0]==="me072" | args[0]==="Dedenne" | args[0]==="dedenne"){
        var ME072 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- POKÉMON SKILL -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/8/8f/Lucky_Banner.png/revision/latest/scale-to-width-down/637?cb=20180212012544`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐⭐⭐⭐`)
            .addField(`Số điểm (Points):`,`1064/1300`)
            .addField(`Kỹ năng (Skills):`,`Giảm 15% khi mua đồ (2 lần/tháng)
            Kho đồ được mở rộng
            Không bị trừ Point khi bán đồ`);
    ...
    if(args[0]==="ME240"| args[0]==="Me240" | args[0]==="me240"| args[0]==="Dewott" | args[0]==="dewott"){
        var ME240 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐`)
            .addField(`Số điểm (Points):`,`207/300`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME099** | **.skill ME381**`)
    ...
    if(args[0]==="ME716"| args[0]==="Me716" | args[0]==="me716"| args[0]==="Purrloin" | args[0]==="purrloin"){
        var ME716 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐`)
            .addField(`Số điểm (Points):`,`261/300`)
            .addField(`Kỹ năng (Skills):`,`---`);
    ...
    if(args[0]==="ME456"| args[0]==="Me456" | args[0]==="me456" | args[0]==="Megasableye" | args[0]==="megasableye"){
        var ME456 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐`)
            .addField(`Số điểm (Points):`,`488/525`)
            .addField(`Kỹ năng (Skills):`,`---`);
    ...
    if(args[0]==="ME441"| args[0]==="Me441" | args[0]==="me441" | args[0]==="Sableye" | args[0]==="sableye"){
        var ME441 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- POKÉMON SKILL -`).setImage(`https://i.imgur.com/QdFUiY7.gif`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`---`)
            .addField(`Số điểm (Points):`,`11/150`)
            .addField(`Kỹ năng (Skills):`,`---`);
    ...
    if(args[0]==="ME014"| args[0]==="Me014" | args[0]==="me014"){
        var ME014 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- POKÉMON SKILL -`).setImage(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/d/db/475_%28shiny%29.gif`)
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME014** | **.skill ME110**`)
    ...
    if(args[0]==="ME607"| args[0]==="Me607" | args[0]==="me607"| args[0]==="Zygarde" | args[0]==="zygarde"){
        var ME607 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`---`)
            .addField(`Số điểm (Points):`,`146/150`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME867** | **.skill ME662**`)
    ...
    if(args[0]==="ME906"| args[0]==="Me906" | args[0]==="me906"| args[0]==="Cherrim" | args[0]==="cherrim"){
        var ME906 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐⭐⭐⭐`)
            .addField(`Số điểm (Points):`,`822/980`)
            .addField(`Kỹ năng (Skills):`,`Giảm 10% khi mua đồ (2 lần/tháng)
Kho đồ được mở rộng`);
    ...
    if(args[0]==="ME905"| args[0]==="me905" | args[0]==="Me905" | args[0]==="MegaDiancie" | args[0]==="Megadiancie" | args[0]==="megadiancie"){
        var ME905 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐`)
            .addField(`Số điểm (Points):`,`185/300`)
            .addField(`Kỹ năng (Skills):`,`---`);
    ...
    if(args[0]==="ME923"| args[0]==="me923" | args[0]==="Me923" | args[0]==="MegaLucario" | args[0]==="Megalucario" | args[0]==="megalucario"){
        var ME923 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`---`)
            .addField(`Số điểm (Points):`,`92/150`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME037** | **.skill ME813**`)
    ...
    if(args[0]==="ME503"| args[0]==="Me503" | args[0]==="me503"| args[0]==="Arcanine" | args[0]==="arcanine"){
        var ME503 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐`)
            .addField(`Số điểm (Points):`,`202/300`)
            .addField(`Kỹ năng (Skills):`,`---`);
...
Vui lòng dùng code để tra cứu theo các lệnh sau: **.skill ME983** | **.skill ME452**`)
    ...
    if(args[0]==="ME303"| args[0]==="me303" | args[0]==="Me303" | args[0]==="Bewear" | args[0]==="bewear"){
        var ME303 = new Discord.RichEmbed().setColor(`#3A77E6`)
            .setTitle(`- POKÉMON SKILL -`).setImage(`https://i.imgur.com/jZE0T8G.gif`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`---`)
            .addField(`Số điểm (Points):`,`28/150`)
            .addField(`Kỹ năng (Skills):`,`---`);
    ...
    if(args[0]==="ME969"| args[0]==="me969" | args[0]==="Me969" | args[0]==="Pancham" | args[0]==="pancham"){
        var ME969 = new Discord.RichEmbed().setColor(`#3A77E6`)
            ...
            .setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/a/a6/Member_Logo.png/revision/latest?cb=20170613044002`)
            .addField(`Cấp bậc (Rank):`,`⭐`)
            .addField(`Số điểm (Points):`,`258/300`)
            .addField(`Kỹ năng (Skills):`,`---`);
