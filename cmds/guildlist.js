...
module.exports.run = async (pw, message, args) => {
    ...
    if(args[0]==="G002"){
        var G002 = new Discord.RichEmbed()
            .setTitle(`- NATURIA -`).setColor(`#7FFFD4`).setURL(`https://pmdv-nexus.wikia.com/wiki/Naturia`).setThumbnail(`https://vignette.wikia.nocookie.net/pmdv-nexus/images/f/f5/Guild_Leader_Badge.png/revision/latest?cb=20180616005707`)
        ...
        var ACG002 = new Discord.RichEmbed().setColor(`#7FFFD4`)
