...
if (roll == 5 || roll == 10 || roll == 15 || roll == 20 || roll == 25 || roll == 30 || roll == 35 || roll == 40 || roll == 45 || roll == 50 || roll == 55 || roll == 60 || roll == 65 || roll == 70 || roll == 75 || roll == 80 || roll == 85 || roll == 90 || roll == 95 || roll == 100 || roll == 4 || roll == 6 || roll == 14 || roll == 19 || roll == 24)
    message.channel.sendMessage("Bạn đã nhận được 100 :poke: từ hòm kho báu ! Chúc mừng");
    ...
    message.channel.sendMessage("Bạn đã nhận được 150 :poke: từ hòm kho báu ! Chúc mừng");
    ...
    message.channel.sendMessage("Bạn đã nhận được 200 :poke: từ hòm kho báu ! Chúc mừng");
    ...
    message.channel.sendMessage("Bạn đã nhận được 250 :poke: từ hòm kho báu ! Chúc mừng");

else if (roll == 79 || roll == 81 || roll == 83|| roll == 87 || roll == 89|| roll == 91 || roll == 93|| roll == 97 || roll == 99|| roll == 18)
    message.channel.sendMessage("Bạn đã nhận được 300 :poke: từ hòm kho báu ! Chúc mừng");

else if (roll == 22 || roll == 26 || roll == 34|| roll == 38 || roll == 54|| roll == 42 || roll == 46)
    message.channel.sendMessage("Bạn đã nhận được 325 :poke: từ hòm kho báu ! Chúc mừng");

else if (roll == 54 || roll == 58 || roll == 62|| roll == 66 || roll == 74)
    message.channel.sendMessage("Bạn đã nhận được 350 :poke: từ hòm kho báu ! Chúc mừng");

else if (roll == 78 || roll == 82 || roll == 86)
    message.channel.sendMessage("Bạn đã nhận được 400 :poke: từ hòm kho báu ! Chúc mừng");
